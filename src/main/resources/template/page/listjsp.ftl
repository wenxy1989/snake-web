...
function doDelete(id){
	if(confirm("delete?")){
		window.location.href = "${"$"}{basePath }/${model.javaName}/delete?id=" + id;
	}
}
</script>
<body>
	...
	<td>
	<a href="${"$"}{basePath }/${model.javaName}/toEdit?id=${"$"}{obj.id }">edit</a>
	...
	<a href="${"$"}{basePath }/${model.javaName}/toCreate" class="btn btn-lg btn-success">NEW</a>
	</div>
</body>
</html>