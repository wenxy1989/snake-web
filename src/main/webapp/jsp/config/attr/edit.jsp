...
<form id="frm" action="${basePath }/attr/edit.do" method="POST">
...
<div id="div_java_type" class="ui selection dropdown">
  <input type="hidden" name="javaType" value="${object.javaType }">
  <div class="text">${object.javaType }</div>
...
<input type="checkbox" name="allowBlank" value="1"<c:if test="${object.allowBlank == 1}"> checked="checked"</c:if>>
<label>allowBlank</label>
</div>
</div>
<div class="field">
<div class="ui toggle checkbox">
<input type="checkbox" name="autoIncrement" value="1"<c:if test="${object.autoIncrement == 1}"> checked="checked"</c:if>>
<label>autoIncrement</label>
</div>
</div>
<div class="field">
<div class="ui selection dropdown">
  <input type="hidden" name="useType" value="${object.useType }">
  <div class="text" data-value="<c:if test="${empty object.useType}">save</c:if><c:if test="${not empty object.useType}">${object.useType }</c:if>"></div>
  <i class="dropdown icon"></i>
  <div class="menu">
...
<div class="field">
<div class="ui selection dropdown">
  <input type="hidden" name="pageStyle" value="${object.pageStyle}">
  <div class="text" data-value="${object.pageStyle}"></div>
  <i class="dropdown icon"></i>
  <div class="menu">
