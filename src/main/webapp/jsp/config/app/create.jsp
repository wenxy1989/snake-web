	...
	$('.ui.form').form(
		{
			...
			database:{
				identifier:'database',
				rules:[{type:'maxLength[25]',prompt:'database mostly 25 characters'}]
			},
			title:{
				identifier:'title',
...
<form id="frm" action="${basePath }/app/create.do" method="POST">
<div class="field">
<label>Name</label>
...
<input title="please input database" type="text" name="database" placeholder="database" value="${object.database }">
</div>
</div>
<div class="field">
<label>Title</label>
