...
<form id="frm" action="${basePath }/obj/edit.do" method="POST">
<input type="hidden" name="id" value="${object.id }">
<input type="hidden" name="applicationId" value="${object.applicationId }">
...
<div class="field">
<label>Table</label>
<input title="please input table" type="text" name="table" placeholder="table" value="${object.table }">
</div>
</div>
<div class="field">
<label>Title</label>
