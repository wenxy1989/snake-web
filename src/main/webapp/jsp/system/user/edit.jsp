...
<html>
  ...
  <body>
	<form id="frm" action="${basePath }/user/edit.do" method="POST">
	...
	<div class="i_c">
        ...
        <div class="b_02"></div>
	    <div class="login">
	  	<p><input title="请填写用户名" type="text" name="name" class="l_input" value="${object.name }"></p>
	  	<p><input title="请填写登录名" type="text" name="loginname" class="l_input" value="${object.loginName }"></p>
	  	<p><input title="请填写登录名" type="text" name="password" class="l_input" value="${object.password }"></p>
