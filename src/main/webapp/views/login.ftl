...
<head lang="en">
    ...
    <script type="text/javascript">
        function initLogin() {
            if (window.parent && window.parent.toLogin) {
...
<div class="am-g">
    <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        <form method="post" class="am-form" action="${request.contextPath}/doLogin">
            <label for="input_user">用户名:</label>
            <input type="text" name="username" id="input_user" value="admin">
            <br>
            ...
            <div class="am-cf">
                ...
                <input value="忘记密码 ^_^? " class="am-btn am-btn-default am-btn-sm am-fr">
            </div>
            <div>
                <label class="am-comment-danger">${SPRING_SECURITY_LAST_EXCEPTION.message}</label>
            </div>
        </form>
        <hr>
