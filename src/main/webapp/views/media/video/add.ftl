            ...
            <div class="am-g">
                ...
                <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                    <form class="am-form am-form-horizontal" method="post" action="${request.contextPath}/user/add">
                        ...
                        <div class="am-form-group">
                            <label for="user-email" class="am-u-sm-3 am-form-label">登录名 / Email</label>
                            <div class="am-u-sm-9">
                                <input type="text" id="login-name" name="loginName" placeholder="输入你的登录名 / Email">
                                <small>邮箱你懂得...</small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="password" id="user-phone" name="loginPwd" placeholder="输入你的电话号码 / Telephone">
                            </div>
                        </div>
