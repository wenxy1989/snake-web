...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">数据列信息</strong> / <small>添加</small></div>
        </div>

        <div class="am-g">

            <div class="am-u-sm-12 am-u-md-10">
                <form class="am-form am-form-horizontal" method="post" action="${request.contextPath}/mysql/column/${tableId}/add">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="autoIncrement" placeholder="是否自增 / AutoIncrement" required>
                            <small>数据列是否自增</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="allowBlank" placeholder="可以为空 / AllowBlank" required>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="defaultValue" placeholder="默认值" required>
                            <small>数据列默认值</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="orderPosition" placeholder="排序/位置" required>
