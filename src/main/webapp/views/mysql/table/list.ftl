...
<script type="text/javascript">
    function toAdd(){
        window.location.href='${request.contextPath}/mysql/table/${databaseId}/toAdd';
    }
    function toDelete(id){
        if(confirm(" delete ?")){
            window.location.href = "${request.contextPath}/mysql/table/${databaseId}/delete?id="+id;
        }
    }
    function toEdit(id){
        window.location.href = "${request.contextPath}/mysql/table/${databaseId}/toEdit?id="+id;
    }
    function toColumn(id){
        window.location.href = "${request.contextPath}/mysql/column/"+id+"/page";
    }
    function toDatabaseImport(){
        window.location.href = "${request.contextPath}/mysql/table/${databaseId}/importDatabase";
    }
    function toClean(){
        myConfirm("提示","确认清空数据列？",function(){
            window.location.href = "${request.contextPath}/mysql/table/${databaseId}/clean";
        });
    }
</script>
<body>
...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">${database.name}(${database.code}) 表结构</strong> / <small>列表</small></div>
        </div>
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-4">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        ...
                        <button type="button" class="am-btn am-btn-success" onclick="toDatabaseImport()">
            ...
            <div class="am-u-sm-12 am-u-md-8">
                <form method="post" action="${request.contextPath}/mysql/table/${databaseId}/page">
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <td class="table-set">
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="javascript:toColumn(${obj.id})" class="am-btn am-btn-default am-btn-xs am-text-secondary">
                                            <span class="am-icon-code-fork">数据列</span>
                                        </a>
                    ...
                    <@pager.guid pageUrl="/mysql/table/${databaseId}/page" page=page />
                    </div>
                </form>
            </div>
