    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-10">
                <form class="am-form am-form-horizontal" method="post" action="${request.contextPath}/inter/result/${urlId}/edit">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="name" placeholder="名称 / Name" value="${result.name}" required>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="code" placeholder="代码层参数名称 / Code" value="${result.code}" required>
                            <small>代码层参数名称</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select name="isArray" data-am-selected="{btnSize: 'sm'}" required>
                                <option value="0"<#if !result.isArray> selected="selected" </#if>>否</option>
                                <option value="1"<#if result.isArray> selected="selected" </#if>>是</option>
                            </select>
                            <small>是否是集合</small>
                        </div>
                    </div>

                <@i_com.selectType value=result.type example=result.example type="extend" />
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select name="allowBlank" data-am-selected="{btnSize: 'sm'}">
                                <option value="1"<#if result.allowBlank>selected=selected</#if>>是</option>
                                <option value="0"<#if !result.allowBlank>selected=selected</#if>>否</option>
                            </select>
                            <small>是否可以为空</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="regex" placeholder="规则 / Regex" value="${result.regex}" required>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea class="" rows="5" name="remark"
                                      placeholder="备注 / Remark">${result.remark}</textarea>
                        </div>
                    </div>
