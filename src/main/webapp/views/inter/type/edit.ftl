            ...
            <div class="am-u-sm-12 am-u-md-10">
                <form class="am-form am-form-horizontal" method="post" action="${request.contextPath}/inter/parameter/edit">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="name" placeholder="名称 / Name" value="${parameter.name}">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="code" placeholder="代码层参数名称 / Code" value="${parameter.code}">
                            <small>代码层参数名称</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="type" placeholder="类型 / Type" value="${parameter.type}">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="number" name="length" placeholder="长度 / Length" value="${parameter.length}">
                    ...
                    <#--<div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <select name="allowBlank" data-am-selected="{btnSize: 'sm'}" value="${parameter.allowBlank}">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="regex" placeholder="规则 / Regex" value="${parameter.regex}">
                    ...
                    <#--<div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="position" placeholder="位置 / Position" value="${parameter.position}">
                            <small>参数传递的位置</small>
                        </div>
                    </div>-->
