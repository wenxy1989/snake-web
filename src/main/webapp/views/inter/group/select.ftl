...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            <form id="form-query" method="post" action="${request.contextPath}/inter/group/${applicationId}/select">
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                <form class="am-form">
                    ...
                    <@pager.guid pageUrl="/inter/group/${applicationId}/select" page=page type="select" />
                    </div>
                </form>
            </div>
