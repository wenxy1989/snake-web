...
<script src="${request.contextPath}/assets/js/polyfill/rem.min.js"></script>
<script src="${request.contextPath}/assets/js/polyfill/respond.min.js"></script>
<script src="${request.contextPath}/assets/js/amazeui.legacy.js"></script>
<![endif]-->
