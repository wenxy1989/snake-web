...
<script type="text/javascript">
    function toAdd(){
        window.location.href="${request.contextPath}/book/element/toAdd";
    }
    function toDelete(id){
        if(confirm(" delete ?")){
            window.location.href = "${request.contextPath}/book/element/delete?id="+id;
        }
    }
    function toEdit(id){
        window.location.href = "${request.contextPath}/book/element/toEdit?id="+id;
    }
</script>
<#include "/header.ftl"/>
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">句子元素/句子成分</strong> / <small>列表</small></div>
        </div>
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        ...
                                        <a href="${request.contextPath}/book/element/toEdit?id=${obj.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary">
                ...
                <#import "/common/pager.ftl" as pager>
                    <@pager.guid pageUrl="/book/element/page" page=page />
                </form>
            </div>
