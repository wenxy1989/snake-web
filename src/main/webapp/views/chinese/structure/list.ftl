...
<script type="text/javascript">
    function toAdd(){
        window.location.href="${request.contextPath}/book/structure/toAdd";
    }
    function toDelete(id){
        if(confirm(" delete ?")){
            window.location.href = "${request.contextPath}/book/structure/delete?id="+id;
        }
    }
    function toEdit(id){
        window.location.href = "${request.contextPath}/book/structure/toEdit?id="+id;
    }
</script>
<#include "/header.ftl"/>
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">语句结构</strong> / <small>列表</small></div>
        </div>
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tr>
                            ...
                            <td class="am-hide-sm-only"><#if obj.type==1>完整语句<#else>词组短语</#if></td>
                            <td class="am-hide-sm-only">${obj.createdTime}</td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="${request.contextPath}/book/structure/toEdit?id=${obj.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary">
                ...
                <#import "/common/pager.ftl" as pager>
                    <@pager.guid pageUrl="/book/structure/page" page=page />
                </form>
            </div>
