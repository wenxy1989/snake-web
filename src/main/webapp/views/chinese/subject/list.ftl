...
<script type="text/javascript">
    function toAdd(){
        window.location.href="${request.contextPath}/book/subject/toAdd";
    }
    function toDelete(id){
        if(confirm(" delete ?")){
            window.location.href = "${request.contextPath}/book/subject/delete?id="+id;
        }
    }
    function toEdit(id){
        window.location.href = "${request.contextPath}/book/subject/toEdit?id="+id;
    }
</script>
<#include "/header.ftl"/>
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">语句主体</strong> / <small>列表</small></div>
        </div>
        ...
        <div class="am-g">
                        ...
                        <td>
                            <div class="am-btn-toolbar">
                                ...
                                <#--<a href="javascript:toAdd(${obj.id})" class="am-btn am-btn-default am-btn-xs am-text-secondary">
                                    ...
                                    <a href="${request.contextPath}/book/subject/toEdit?id=${obj.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary">
            ...
            <@pager.guid pageUrl="/book/subject/page" page=page />
            </div>
